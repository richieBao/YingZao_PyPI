# -*- coding: utf-8 -*-
"""
HuaGong_4PU_INOUT_1ChaoJuantou_Solver · Step 1（DBJsonReader）+ Step 2（Timber_block_uniform）+ Step 3（卷殺 Juansha）
...
# ==============================================================
# 主 Solver 类 —— HuaGong_4PU_INOUT_1ChaoJuantou_Solver
# ==============================================================

class HuaGong_4PU_INOUT_1ChaoJuantou_Solver(object):
    ...
    def step1_read_db(self):
        try:
            reader = DBJsonReader(
                ...
                table="DG_Dou",
                key_field="type_code",
                key_value="HuaGong_4PU_INOUT_1ChaoJuantou",
                field="params_json",
                json_path=None,
                export_all=True,
                ghenv=self.ghenv
...
if __name__ == "__main__":
    ...
    solver = HuaGong_4PU_INOUT_1ChaoJuantou_Solver(DBPath, base_point, Refresh, ghenv).run()
