...
Step 2: ChaAng4Pu -> 调用 yingzao.ancientArchi.ChaAngQiAo 生成插昂剖面/实体等
...
from yingzao.ancientArchi import (
    ChaAngQiAo, _coerce_point3d, _coerce_bool,
...
if __name__ == "__main__":
    ...
    solver = ChaAng4PUSolver(DBPath, base_point, Refresh)
    solver.run()
