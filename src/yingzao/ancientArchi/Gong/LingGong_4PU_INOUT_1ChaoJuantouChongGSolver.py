...
class LingGong_4PU_INOUT_1ChaoJuantouChongGSolver(object):
    ...
    def step1_read_db(self):
        ...
        try:
            reader = DBJsonReader(
                ...
                table="DG_Dou",
                key_field="type_code",
                key_value="LingGong_4PU_INOUT_1ChaoJuantouChongG",   # 令栱在表中的 type_code
                field="params_json",
                json_path=None,
                export_all=True,
                ghenv=self.ghenv
...
if __name__=="__main__":
    ...
    solver = LingGong_4PU_INOUT_1ChaoJuantouChongGSolver(DBPath, base_point, Refresh, ghenv)
    solver = solver.run()
